          ...
          <div className="flex flex-col flex-1" style={{ gap: `${spacing}px` }}>
            ...
            <button
              ...
              className={`flex items-center ${isSidebarCollapsed ? 'justify-center' : 'gap-3'} rounded-lg transition-colors ${
                activeMenu === "Dashboard" ? "bg-yellow-400/10 text-yellow-400" : "text-zinc-400 hover:bg-zinc-800 hover:text-white"
              }`}
            ...
            <button
              onClick={() => setActiveMenu("New Appointment")}
              className={`flex items-center ${isSidebarCollapsed ? 'justify-center' : 'gap-3'} rounded-lg transition-colors ${
                activeMenu === "New Appointment" ? "bg-yellow-400/10 text-yellow-400" : "text-zinc-400 hover:bg-zinc-800 hover:text-white"
              }`}
              style={{ padding: `${spacing}px ${isSidebarCollapsed ? spacing : cardPadding}px`, fontSize: `${responsive.fontSize.body}px` }}
              title="New Appointment"
            >
            ...
            <button
              ...
              className={`flex items-center ${isSidebarCollapsed ? 'justify-center' : 'gap-3'} rounded-lg transition-colors ${
                activeMenu === "Calendar" ? "bg-yellow-400/10 text-yellow-400" : "text-zinc-400 hover:bg-zinc-800 hover:text-white"
              }`}
              style={{ padding: `${spacing}px ${isSidebarCollapsed ? spacing : cardPadding}px`, fontSize: `${responsive.fontSize.body}px` }}
              title="Calendar"
            >
            ...
            <button
              ...
              className={`flex items-center ${isSidebarCollapsed ? 'justify-center' : 'gap-3'} rounded-lg transition-colors ${
                activeMenu === "Appointments" ? "bg-yellow-400/10 text-yellow-400" : "text-zinc-400 hover:bg-zinc-800 hover:text-white"
              }`}
              style={{ padding: `${spacing}px ${isSidebarCollapsed ? spacing : cardPadding}px`, fontSize: `${responsive.fontSize.body}px` }}
              title="Appointments"
            >
            ...
            <button
              ...
              className={`flex items-center ${isSidebarCollapsed ? 'justify-center' : 'gap-3'} rounded-lg transition-colors ${
                activeMenu === "Services" ? "bg-yellow-400/10 text-yellow-400" : "text-zinc-400 hover:bg-zinc-800 hover:text-white"
              }`}
              style={{ padding: `${spacing}px ${isSidebarCollapsed ? spacing : cardPadding}px`, fontSize: `${responsive.fontSize.body}px` }}
              title="Services"
            >
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          >
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        <div className="font-semibold" style={{ fontSize: `${responsive.fontSize.body}px` }}>{apt.name}</div>
                        <div className="text-yellow-400" style={{ fontSize: `${responsive.fontSize.small}px` }}>{apt.service}</div>
            ...
            <div
              ...
              style={{ padding: `${cardPadding}px` }}
            >
              <h2 className="font-bold" style={{ fontSize: `${responsive.fontSize.subheading}px`, marginBottom: `${spacing / 2}px` }}>
                Quick Actions
              </h2>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, 1fr)', gap: `${spacing}px` }}>
